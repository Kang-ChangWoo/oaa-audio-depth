...
JOBS=(
"0820_sslam_llrd_r6_mp3d|data_mp3d|$SL --nviews 6 --data-mode r6 --epochs 30 --batch-size 4 --accum 1 --stem-stride1"
"0820_sslam_llrd_r8_mp3d|data_mp3d|$SL --nviews 8 --data-mode r8 --epochs 30 --batch-size 4 --accum 1 --stem-stride1"
"0820_sslam_r8vd_rep|data_0422|--audio-backbone sslam --nviews 8 --data-mode r8 --epochs 40 --batch-size 3 --accum 11 --subset-aug --vdrop-kmax 4"
)
SJOBS=()
