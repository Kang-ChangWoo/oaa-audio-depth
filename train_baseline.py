...
cosine, bf16 autocast, grad-clip 1.0, model-select on cos-lat-weighted val MAE. Loss/metric are computed at 256x512 for every
baseline exactly like OAA (ViT/EchoScan/Beyond predict natively at 256x512; the ResNet-50 decoder ends at
64x128 and is bilinearly upsampled x4 after the sigmoid head).
