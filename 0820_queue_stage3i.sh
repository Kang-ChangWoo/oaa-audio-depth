...
JOBS=(
"0820_eatllrd_ar005_fb_rep|data_0422|--audio-backbone eat --afm-llrd 0.75 --warmup-ep 8 --loss-absrel 0.05 --nviews 4 --data-mode fb --epochs 40 --batch-size 8 --accum 4"
)
SJOBS=()
for s in $SEEDS; do
  for j in "${JOBS[@]}"; do
