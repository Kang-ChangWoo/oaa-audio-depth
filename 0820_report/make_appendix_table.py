...
CELLS=[
 ...
 ('MP3D 8ch',mp,[('OAA-CNN','oaa_r8_fin'),('EchoScan','es_r8_fin'),('EchoDiffusion','eco_r8'),('eat+LLRD novd s0','0820_eatllrd_r8novd_mp3d'),('eat+LLRD+cs','0820_eatllrd_cs_r8_mp3d'),('eat+LLRD vd','0820_eatllrd_r8_mp3d')]),
]
rows=[]
