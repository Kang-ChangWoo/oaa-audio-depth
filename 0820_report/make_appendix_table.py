...
CELLS=[
 ...
 ('Replica 6ch',rep,[('OAA-CNN','oaa_r6_fin'),('EchoScan','es_r6_fin'),('EchoDiffusion','eco_r6_fin'),('Beyond-I2D','0820_beyond_r6_rep'),('eat+LLRD','0820_eatllrd_r6_rep'),('eat+LLRD+cs','0820_eatllrd_cs_r6_rep'),('sslam s0','0820_sslam_r6_rep'),('sslam s1','0820_sslam_r6_rep_s1'),('sslam s2','0820_sslam_r6_rep_s2'),('sslam+LLRD','0820_sslam_llrd_r6_rep')]),
 ('Replica 8ch',rep,[('OAA-CNN','oaa_r8_fin'),('EchoScan','es_r8_fin'),('EchoDiffusion','eco_r8_fin'),('Beyond-I2D','0820_beyond_r8_rep'),('eat+LLRD vd','0820_eatllrd_r8_rep'),('eat+LLRD+cs vd','0820_eatllrd_cs_r8_rep'),('sslam vd','0820_sslam_r8vd_rep'),('sslam+LLRD vd','0820_sslam_llrd_r8vd_rep')]),
 ('MP3D 2ch',mp,[('OAA-CNN','oaa_r2_fin'),('EchoScan','es_r2_fin'),('EchoDiffusion','eco_r2_fin'),('Beyond-I2D','0820_beyond_r2_rep'),('eat+LLRD','0820_eatllrd_r2_mp3d'),('eat+LLRD+cs','0820_eatllrd_cs_r2_mp3d'),('sslam+LLRD+cs','0820_sslamllrd_cs_r2_mp3d'),('sslam','0820_sslam_r2_mp3d'),('sslam+LLRD','0820_sslam_llrd_r2_mp3d')]),
 ('MP3D 4ch',mp,[('OAA-CNN','oaa_fb_fin'),('EchoScan','es_fb_fin'),('EchoDiffusion','eco_fb_wstd'),('eat+LLRD s0','0820_eat_llrd_fb_mp3d'),('sslam+LLRD+cs','0820_sslamllrd_cs_fb_mp3d'),('sslam','0820_sslam_fb_mp3d'),('sslam+LLRD65','0820_sslam_llrd65_fb_mp3d')]),
 ('MP3D 6ch',mp,[('OAA-CNN','oaa_r6_fin'),('EchoScan','es_r6_fin'),('EchoDiffusion','eco_r6'),('eat+LLRD','0820_eatllrd_r6_mp3d'),('eat+LLRD+vd','0820_eatllrd_r6vd_mp3d'),('eat+LLRD+cs','0820_eatllrd_cs_r6_mp3d'),('sslam','0820_sslam_r6_mp3d'),('sslam+LLRD','0820_sslam_llrd_r6_mp3d'),('sslam+LLRD+cs','0820_sslamllrd_cs_r6_mp3d')]),
 ('MP3D 8ch',mp,[('OAA-CNN','oaa_r8_fin'),('EchoScan','es_r8_fin'),('EchoDiffusion','eco_r8'),('eat+LLRD novd s0','0820_eatllrd_r8novd_mp3d'),('eat+LLRD+cs','0820_eatllrd_cs_r8_mp3d'),('sslam','0820_sslam_r8_mp3d'),('sslam+LLRD','0820_sslam_llrd_r8_mp3d'),('eat+LLRD vd','0820_eatllrd_r8_mp3d')]),
]
rows=[]
