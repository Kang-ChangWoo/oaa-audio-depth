...
JOBS=(
"0820_sslam_r6_rep|data_0422|--audio-backbone sslam --nviews 6 --data-mode r6 --epochs 40 --batch-size 4 --accum 8"
"0820_sslam_r8_rep|data_0422|--audio-backbone sslam --nviews 8 --data-mode r8 --epochs 40 --batch-size 3 --accum 11"
)
SJOBS=()
for s in $SEEDS; do
  for j in "${JOBS[@]}"; do
